...
class TeamForm(FlaskForm):
    form_teamname = StringField("Please enter the name of your Team", validators=[DataRequired()])
    form_city = StringField("Please enter the City your team is from", validators=[DataRequired()]) 
    submit = SubmitField('create team')

class PlayerForm(FlaskForm):
    form_playername = StringField("Please Enter the full name of your player", validators=[DataRequired()])
...
class UpdateTeam(FlaskForm):
    form_teamname = StringField("Please enter the new name of your Team", validators=[DataRequired()])
    form_city = StringField("Please enter the City your team is from", validators=[DataRequired()]) 
    submit = SubmitField('create team')
